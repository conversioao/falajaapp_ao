            ...
            <div className="p-10 pb-0 shrink-0">
                <div className="flex items-center gap-3 mb-12 cursor-pointer relative" onClick={() => setActivePage('dashboard')}>
                    ...
                    <div className="ml-auto relative group">
                        <div className="p-2 rounded-full bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-all">
                            <Bell size={20} />
                            {(user.unreadCount || 0) > 0 && (
                                <span className="absolute -top-1 -right-1 bg-green-500 text-black text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center border-2 border-black animate-bounce">
